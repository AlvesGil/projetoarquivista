...
import br.ufpa.arquivista.config.audit.AuditEventConverter;
import br.ufpa.arquivista.domain.PersistentAuditEvent;
...
import static br.ufpa.arquivista.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;

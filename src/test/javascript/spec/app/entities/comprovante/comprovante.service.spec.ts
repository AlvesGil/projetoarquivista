...
describe('Service Tests', () => {
    describe('Comprovante Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Comprovante(0, 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Comprovante', async () => {
            ...
            it('should update a Comprovante', async () => {
                const returnedFromService = Object.assign(
                    {
                        mes: 'BBBBBB',
                        ano: 1
            ...
            it('should return a list of Comprovante', async () => {
                const returnedFromService = Object.assign(
                    {
                        mes: 'BBBBBB',
                        ano: 1
            ...
            it('should delete a Comprovante', async () => {
